    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-lg border border-gray-700 rounded-2xl shadow-xl p-8">
                <h1 className="text-3xl font-bold text-center text-teal-400 mb-4">Login</h1>
                <p className="text-center text-sm text-gray-400 mb-6">
                    Don't have an account yet? <a href="/signup" className="text-teal-300 hover:underline">Sign up here</a>
                </p>
                ...
                <form onSubmit={loginForm.handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" onChange={loginForm.handleChange} value={loginForm.values.email} className="w-full px-4 py-3 rounded-lg bg-gray-900/50 border border-gray-700 text-gray-200 focus:ring-2 focus:ring-teal-400 focus:outline-none" />
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" onChange={loginForm.handleChange} value={loginForm.values.password} className="w-full px-4 py-3 rounded-lg bg-gray-900/50 border border-gray-700 text-gray-200 focus:ring-2 focus:ring-teal-400 focus:outline-none" />
                        {loginForm.errors.password && loginForm.touched.password && (
                            <p className="text-xs text-red-400 mt-1">{loginForm.errors.password}</p>
                        )}
                        <div className="text-right mt-1">
                            <a href="/forgot-password" className="relative inline-block text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-blue-400 transition duration-300 ease-in-out hover:from-pink-400 hover:to-purple-500" >
                                Forgot password?
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center">
                        <input type="checkbox" id="remember" name="remember" onChange={loginForm.handleChange} checked={loginForm.values.remember} className="mr-2" />
                        <label htmlFor="remember" className="text-sm text-gray-300">Remember me</label>
                    </div>

                    {/* Submit */}
                    <button type="submit" className="w-full py-3 px-4 rounded-lg bg-linear-to-r from-teal-400 to-blue-500 text-black font-bold hover:from-teal-300 hover:to-blue-400 transition" >
                        Login
                    </button>
                </form>
            </div>
        ...
        // <div className="mt-7 w-1/3 mx-auto bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-600 dark:border-neutral-400">
